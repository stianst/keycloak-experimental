...
<head>
    ...
    <link href="${url.resourcesPath}/node_modules/patternfly/dist/css/patternfly.css" rel="stylesheet" />
    <link href="${url.resourcesPath}/node_modules/patternfly/dist/css/patternfly-additions.css" rel="stylesheet" />
    <style>
